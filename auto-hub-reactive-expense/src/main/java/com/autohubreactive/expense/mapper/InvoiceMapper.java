...
public interface InvoiceMapper {
    ...
    @Mapping(target = "returnRentalOfficeId", expression = "java(mapStringToObjectId(newBookingResponse.returnRentalOfficeId()))")
    ...
    @Mapping(target = "returnRentalOfficeId", expression = "java(mapStringToObjectId(invoiceRequest.returnRentalOfficeId()))")
